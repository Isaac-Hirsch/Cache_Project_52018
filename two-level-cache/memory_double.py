...
class Memory:
    def __init__(self, memory_size: int):
        ...
        """
        self._memory_size = memory_size // DOUBLE_SIZE
        self.memory = np.zeros((self._memory_size, ), dtype=np.float64)
        self.address_size = math.ceil(np.log2(self._memory_size))
...
class Cache:
    ...
    @property
    def get_address_size(self) -> int:
        return self.memory.address_size
